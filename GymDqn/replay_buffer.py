...
import random_access_queue


class ReplayBuffer(rb.AbstractReplayBuffer):
    ...
    def __init__(self, capacity: Optional[int] = None, num_steps: int = 1):
        ...
        self.memory = random_access_queue.RandomAccessQueue(maxlen=capacity)
    ...
    def load(self, filename):
        ...
        if isinstance(self.memory, collections.deque):
            # Load v0.2
            self.memory = random_access_queue.RandomAccessQueue(self.memory, maxlen=self.memory.maxlen)
